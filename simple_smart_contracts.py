...
def approval_program():
    ...
    add = Seq([ 
        ...
        App.globalPut(Bytes("Count"), scratchCount.load() + Int(3)),
        Return(Int(1))
    ])
    ...
    print(Txn.application_args.length())
    handle_noop = Cond(
        [And(
...
def main() :
    ...
    # define private keys
    creator_private_key = "ZnmOaVW+VaMJNGO4T9xQzgTlBmt/j2WESEM7v5btxzJT/pTm1zw4ETeu3FP6v2BHAXbAKoxCvBK0GMbWt9iHcQ=="
    # get_private_key_from_mnemonic(creator_mnemonic)
